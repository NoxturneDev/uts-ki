...
class ParallelPolicy
{
    ...
    {
        return $user->can('view_any_parallel');
    }
    ...
    {
        return $user->can('create_parallel');
    }
    ...
    {
        return $user->can('update_parallel');
    }
    ...
    {
        return $user->can('delete_parallel');
    }
    ...
    {
        return $user->can('delete_any_parallel');
    }
     ...
     */
    public function replicate(User $user, Parallel $parallel): bool
    {
